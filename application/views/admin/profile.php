                  ...
                  <form class="form-sample">
                    ...
                    <div class="col-md-3">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <img height="100" width="100" src="<?php echo base_url();?>assets/images/faces/<?php echo $user2[0]->photo; ?>">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                      ...
                      <tr>
                      <td><?php echo $user2[0]->username; ?></td>
                        </tr>
                      <thead>
                        <tr>
                        <th>Role</th>
